...
import { AbstractContribFieldProvider, AbstractContribValidationProvider, WiServiceContribution } from "../../wi-contrib";
...
export declare class SalesForceContribService extends WiServiceContribution {
}
